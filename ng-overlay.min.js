angular.module('overlay').directive('overlay', [
  '$compile',
  function ($compile) {
    'use strict';
    var overlay;
    return {
      ...
      link: function ($scope, iElm, iAttrs) {
        ...
        var position = $scope.overlayPosition || 'top-left', width = $scope.overlayWidth || 100, color = $scope.overlayColor || '#dddddd', textLineHeight = $scope.overlayLineHeight || 12, overlayText = $scope.overlayText || '', show = typeof $scope.overlayShow === undefined ? true : $scope.overlayShow;
        var textWidth = Math.pow(Math.pow(width, 2) + Math.pow(width, 2), 0.5), textTop, textBottom, textLeft, textRight, deg;
